...
import 'package:starfleet_app/screens/dashboard/detail_page.dart';
                    ...
                    return GestureDetector(
                      onTap: () {
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (_) => DetailPage(dataHouse[index])));
                      },
                      child: Container(
                        width: MediaQuery.of(context).size.width,
                        height: 220,
                            ...
                            Container(
                              ...
                              decoration: BoxDecoration(
                                  ...
                                  image: DecorationImage(
                                      image: NetworkImage(
                                          "${dataHouse[index]['image']}"),
                                      fit: BoxFit.cover)),
                              child: Container(
                                margin: EdgeInsets.only(
                                    right: 200, bottom: 100, left: 10, top: 10),
                                decoration: BoxDecoration(
                                    color: Colors.white,
                                    borderRadius: BorderRadius.circular(10)),
                                child: Row(
